  ...
  return (
    <nav style={{
      ...
      <button onClick={() => setMenuOpen(!menuOpen)} style={{
        ...
        {[0,1,2].map(i => (
          <span key={i} style={{ display: 'block', width: 24, height: 1, background: 'var(--gold)' }} />
        ))}
      </button>
      ...
      {menuOpen && (
        <div style={{
          ...
          background: 'rgba(7,7,12,0.98)', backdropFilter: 'blur(20px)',
  ...
  return (
    <section id="hero" style={{
      ...
      <svg style={{ position: 'absolute', top: 0, right: 0, width: '50vw', height: '100%', opacity: 0.06, pointerEvents: 'none' }} viewBox="0 0 600 900" fill="none">
        <line x1="600" y1="0" x2="0" y2="900" stroke="#c9a84c" strokeWidth="0.5" />
        <line x1="600" y1="100" x2="100" y2="900" stroke="#c9a84c" strokeWidth="0.5" />
        <line x1="600" y1="200" x2="200" y2="900" stroke="#c9a84c" strokeWidth="0.5" />
        <circle cx="500" cy="200" r="120" stroke="#c9a84c" strokeWidth="0.5" fill="none" />
        <circle cx="500" cy="200" r="80" stroke="#c9a84c" strokeWidth="0.5" fill="none" />
      </svg>
      ...
      <div style={{ maxWidth: 900, position: 'relative', zIndex: 1 }}>
        ...
        <h1 className="animate-fade-up delay-3" style={{
          ...
          background: 'linear-gradient(120deg, #c9a84c, #e8c97a, #c9a84c)',
        ...
        <div className="animate-fade-up delay-5" style={{ display: 'flex', gap: 20, flexWrap: 'wrap' }}>
          <button onClick={() => document.getElementById('services').scrollIntoView({ behavior: 'smooth' })} style={{
            background: 'linear-gradient(135deg, #c9a84c, #8a6a20)',
            border: 'none', color: '#07070c', cursor: 'pointer',
            fontFamily: 'var(--font-body)', fontSize: 13, fontWeight: 500,
            letterSpacing: 2, textTransform: 'uppercase',
            padding: '16px 36px', borderRadius: 2,
            transition: 'all 0.3s', boxShadow: '0 0 40px rgba(201,168,76,0.2)',
          }}
            onMouseEnter={e => e.currentTarget.style.boxShadow = '0 0 60px rgba(201,168,76,0.4)'}
            onMouseLeave={e => e.currentTarget.style.boxShadow = '0 0 40px rgba(201,168,76,0.2)'}
          >{data.hero.cta}</button>
          <button onClick={() => document.getElementById('contact').scrollIntoView({ behavior: 'smooth' })} style={{
            background: 'none', border: '1px solid rgba(240,237,232,0.3)',
            ...
            onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(240,237,232,0.3)'; e.currentTarget.style.color = 'var(--white-dim)'; }}
          ...
          {data.services.map((s, i) => (
            <div key={s.id}
              ...
              <div style={{
                ...
                color: active === s.id ? 'var(--gold)' : 'rgba(201,168,76,0.4)',
  ...
  return (
    <section id="expertises" ref={ref} style={{
      ...
      <div style={{
        ...
        backgroundImage: 'radial-gradient(circle at 70% 50%, rgba(201,168,76,0.05) 0%, transparent 60%)',
        pointerEvents: 'none',
      }} />
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ opacity: inView ? 1 : 0, transform: inView ? 'none' : 'translateY(30px)', transition: 'all 0.7s ease 0.2s' }}>
          ...
          <button style={{
            ...
            transition: 'all 0.3s', boxShadow: '0 0 40px rgba(201,168,76,0.15)',
          }}
            onMouseEnter={e => e.currentTarget.style.boxShadow = '0 0 60px rgba(201,168,76,0.35)'}
            onMouseLeave={e => e.currentTarget.style.boxShadow = '0 0 40px rgba(201,168,76,0.15)'}
  ...
  return (
    <footer style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        <div style={{ width: 20, height: 20, background: 'linear-gradient(135deg, #c9a84c, #8a6a20)', clipPath: 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)' }} />
